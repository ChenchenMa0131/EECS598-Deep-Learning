...
# -*- coding: utf-8 -*-
"""
Created on Tue Feb 12 09:02:47 2019

@author: chenchenma
"""

from solver import *
from cnn_bn_drop import *
import pickle
import numpy as np
...
solver2.train()
#%%%
test_acc = solver2.check_accuracy(X_test_cnn, Y_test,batch_size=len(Y_test))
print(test_acc)